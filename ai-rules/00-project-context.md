...
This file provides high-level context about the DevAgent project for AI agents.
...
Workflows are structured prompt sequences that run inside this environment. You trigger a workflow by writing `devagent [workflow-name]` with required inputs.

**Common Workflows:**
- `devagent new-task` — Start a new task
- `devagent research` — Research a problem
- `devagent create-plan` — Create an implementation plan
- `devagent implement-plan` — Execute the plan
