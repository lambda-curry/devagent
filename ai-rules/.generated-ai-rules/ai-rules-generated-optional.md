...
Comprehensive guidelines for creating and maintaining high-quality Cursor rules that the AI can follow reliably.: ai-rules/.generated-ai-rules/ai-rules-generated-cursor-rules.md

Storybook setup and authoring rules for apps/ralph-monitoring (Vite + Tailwind v4 + TS path aliases + React Router v7): ai-rules/.generated-ai-rules/ai-rules-generated-storybook.md

Guidelines for proper useEffect usage based on React's "You Might Not Need an Effect" principles, emphasizing when to avoid effects and how to use them correctly for synchronization with external systems.: ai-rules/.generated-ai-rules/ai-rules-generated-useEffect-patterns.md
