...
1. Required inputs (provide in Input Context): None (workflow can proceed with defaults).

2. Optional inputs: branch name, workspace path, migrate uncommitted work flag, base branch/commit.
