...
3. Required: Plan document path (or plan document content). Feature directory path will be inferred from plan document location.
...
**Input Context:**
Plan document path: `.devagent/workspace/features/active/2026-01-02_feature-name/plan/2026-01-02_feature-name-plan.md`
