...
**Today's flow:**
```
research → create-spec → plan-tasks → task prompt drafting
```
...
- **Mitigation:** Task prompt templates already reference task plans as primary input; no breaking changes if specs are removed
