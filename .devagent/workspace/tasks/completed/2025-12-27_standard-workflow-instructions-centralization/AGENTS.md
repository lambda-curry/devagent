...
- Status: Complete
- Task Hub: `.devagent/workspace/tasks/completed/2025-12-27_standard-workflow-instructions-centralization/`
...
- Related: `.devagent/workspace/tasks/completed/2025-10-01_agent-execution-directive/` (example of pattern standardization)
- Related: `.devagent/workspace/tasks/completed/2025-12-27_consistent-date-handling-workflows/` (recent pattern standardization example)
