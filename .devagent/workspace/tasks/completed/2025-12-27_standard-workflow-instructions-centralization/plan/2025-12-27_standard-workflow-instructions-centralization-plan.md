...
- Status: Draft
- Related Task Hub: `.devagent/workspace/tasks/completed/2025-12-27_standard-workflow-instructions-centralization/`
...
- **In Scope:**
  ...
  - Update all 14 workflows to reference standards (research.md, create-plan.md, new-feature.md, implement-plan.md, review-progress.md, review-pr.md, compare-prs.md, brainstorm.md, clarify-task.md, update-product-mission.md, update-tech-stack.md, update-constitution.md, build-workflow.md, mark-task-complete.md)
...
- **Subtasks:**
  ...
  8. Update `brainstorm.md` — Add "Standard Instructions Reference" section, simplify execution directive, date retrieval
     - Validation: Reference section present, instructions simplified
  9. Update `clarify-task.md` — Add "Standard Instructions Reference" section, simplify execution directive, date retrieval
     - Validation: Reference section present, instructions simplified
...
**Related Features:**
- `.devagent/workspace/tasks/completed/2025-10-01_agent-execution-directive/` — Example of execution directive standardization
- `.devagent/workspace/tasks/completed/2025-12-27_consistent-date-handling-workflows/` — Example of date handling standardization
