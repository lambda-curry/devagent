...
- Status: Complete
- Task Hub: `.devagent/workspace/tasks/completed/2026-01-02_rename-new-feature-to-new-task/`

## Summary
Rename the "new-feature" workflow to "new-task" to better reflect its purpose of scaffolding task hubs for any type of work item, not just features. This includes updating workflow files, command files, symlinks, documentation references, and creating a task directory for this scope of work.
...
## Key Decisions
- [2026-01-02] Decision: Rename workflow from "new-feature" to "new-task" to better reflect its purpose of scaffolding work items of any type, not just features. The workflow still creates task hubs (as that's the directory structure), but the naming is more inclusive.

## Progress Log
- [2026-01-02] Event: Created task hub and began rename work. Renamed workflow file from `new-feature.md` to `new-task.md`, updated command file, updated symlinks, updated references in `.devagent/core/AGENTS.md` and `.agents/commands/README.md`, updated README.md. Task directory created.
...
- [2026-01-02] Event: Progress checkpoint captured at `.devagent/workspace/tasks/completed/2026-01-02_rename-new-feature-to-new-task/progress/2026-01-02_checkpoint.md`.
...
- [x] Create new task directory for this scope of work
...
## References
- Plan: `.devagent/workspace/tasks/completed/2026-01-02_rename-new-feature-to-new-task/plan/2026-01-02_rename-new-feature-to-new-task-plan.md`
- Research: None (internal rename; no research required)
- Tasks: None (execution tracked in plan)
- Clarification: `.devagent/workspace/tasks/completed/2026-01-02_rename-new-feature-to-new-task/clarification/2026-01-02_initial-clarification.md`
