...
- Status: Draft
- Related Task Hub: `.devagent/workspace/tasks/active/2026-01-02_rename-new-feature-to-new-task/`
- Stakeholders: Jake Ruesink (Developer, Decision Authority)
- Notes: Internal tooling rename; no external user impact. Sources: `.devagent/workspace/tasks/active/2026-01-02_rename-new-feature-to-new-task/clarification/2026-01-02_initial-clarification.md`, `.devagent/workspace/product/mission.md`.
...
- **Objective:** Workflow behavior remains identical after rename.
  - Baseline: "new-feature" workflow scaffolds task hubs.
...
- Experience narrative: The workflow scaffolds the standard task hub directory structure and metadata, matching the prior "new-feature" behavior.
...
- **Impacted Modules/Files:** `.devagent/core/workflows/new-task.md`, `.agents/commands/new-task.md`, `.cursor/commands/new-task.md`, `.devagent/workspace/tasks/active/2026-01-02_rename-new-feature-to-new-task/`
- **Dependencies:** None.
- **Acceptance Criteria:**
