...
- Status: Research
- Related Feature Hub: `.devagent/workspace/features/active/2026-01-02_audit-slash-commands/`
...
- Examples: `create-plan.md`, `research.md`, `clarify-feature.md`, `review-progress.md`
...
**Commands with Workflows (14 commands):**
- `brainstorm.md` → `brainstorm.md`
- `build-workflow.md` → `build-workflow.md`
- `clarify-feature.md` → `clarify-feature.md`
- `compare-prs.md` → `compare-prs.md`
- `create-plan.md` → `create-plan.md`
- `create-task-prompt.md` → (workflow not found in core/workflows/)
...
- `update-devagent.md` → (workflow not found in core/workflows/)
...
- `clarify-feature.md`: Feature concept (required), optional materials
- `review-progress.md`: Feature directory or feature slug (required), optional scope
...
- `clarify-feature.md`: Interactive session model - may benefit from guidance about starting session
...
- Commands for interactive workflows (`clarify-feature`, `brainstorm`) could mention they start interactive sessions
...
2. **Priority Focus Areas:**
   - **Interactive workflows** (`clarify-feature`, `brainstorm`): Verify commands mention interactive session model
...
4. **Missing Workflows:**
   - Investigate `create-task-prompt.md` and `update-devagent.md` - determine if workflows exist or if commands need updates

## Repo Next Steps

- [ ] Review all 16 command files systematically
- [ ] Verify workflow references are correct for each command
- [ ] Check interactive workflow commands (`clarify-feature`, `brainstorm`) for session model guidance
- [ ] Verify standard workflow commands have adequate input guidance
- [ ] Investigate `create-task-prompt.md` and `update-devagent.md` workflow references
...
**Open Questions:**
- Should interactive workflow commands (`clarify-feature`, `brainstorm`) explicitly mention they start interactive sessions?
...
- What workflows exist for `create-task-prompt` and `update-devagent` commands?
