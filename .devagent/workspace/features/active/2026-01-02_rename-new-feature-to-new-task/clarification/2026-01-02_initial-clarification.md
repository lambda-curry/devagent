...
- **Business context:** The workflow name "new-feature" doesn't accurately reflect its purpose of scaffolding feature hubs for any type of work item, not just features. Renaming to "new-task" better reflects its inclusive purpose.
- **Stakeholders:** Jake Ruesink (Developer, Decision Authority)
- **Prior work:** 
  - Feature hub created: `.devagent/workspace/features/active/2026-01-02_rename-new-feature-to-new-task/`
...
3. Update feature hub status to "Completed" when done
