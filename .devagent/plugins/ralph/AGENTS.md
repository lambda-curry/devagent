...
**The Protocol:**
1. **Detect Branch Hint:** Before starting any task, check the task `description` for a line starting with `Branch: feature/...`.
2. **Autonomous Switch:** 
...
To ensure you are working in the correct git context, always look for a `Branch: feature/...` hint in your task description. If you see one, ensure you are on that branch before making any file changes. If you create a new branch, use the name suggested in the hint.
